...
// The headline score for a barber — either for a specific tag, or their
// deepest-vouched one. Scored out of 5.0.
...
// and express the ratio out of 5.0 — the scale the abacus reads.
  ...
  return Object.values(byTag)
    .map((s) => {
      ...
      return {
        ...s,
        total,
        score: total ? Math.round((s.recommend / total) * 5 * 10) / 10 : 0,
      };
    })
